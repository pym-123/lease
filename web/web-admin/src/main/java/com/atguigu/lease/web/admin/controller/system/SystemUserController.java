...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        ...
        IPage<SystemUserItemVo> systemUserItemVoIPage =  systemUserService.getSystemUserItemVoPage(iPage,queryVo);
    ...
    public Result saveOrUpdate(@RequestBody SystemUser systemUser) {
      ...
      //  String s = DigestUtils.md5DigestAsHex(systemUser.getPassword().getBytes());
    ...
    public Result updateStatusByUserId(@RequestParam Long id, @RequestParam BaseStatus status) {
        ...
        systemUserLambdaUpdateWrapper.set(status!=null,SystemUser::getStatus,status);
