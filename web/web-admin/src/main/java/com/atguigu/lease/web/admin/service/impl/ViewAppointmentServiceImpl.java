...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> pageAppointmentVoList(IPage<AppointmentVo> iPage, AppointmentQueryVo queryVo) {

        return viewAppointmentMapper.selectPageAppointmentVoList(iPage,queryVo);
    }
}
